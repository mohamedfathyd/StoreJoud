        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(phone.getText().toString()!=null){
                    ...
                    Toast.makeText(PhoneUpdate.this,"من فضلك ادخل الاسم ليتم تعديله",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    public void fetchwithoutImage(){
        progressDialog = ProgressDialog.show(PhoneUpdate.this, "جاري تعديل البيانات", "Please wait...", false, false);
        progressDialog.show();
        ...
        call.enqueue(new Callback<contact_general_user_update>() {
            ...
            public void onResponse(Call<contact_general_user_update> call, Response<contact_general_user_update> response) {
                ...
                message.setText("تم تعديل رقم الهاتف بنجاح");
                dialog1.show();
            }
