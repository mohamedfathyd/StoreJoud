    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivity(new Intent(EmailUpdate.this,account.class));
                finish();
            }
        });
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(email.getText().toString()!=null){
                    ...
                    Toast.makeText(EmailUpdate.this,"من فضلك ادخل الاسم ليتم تعديله",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    public void fetchwithoutImage(){
        progressDialog = ProgressDialog.show(EmailUpdate.this, "جاري تعديل البيانات", "Please wait...", false, false);
        progressDialog.show();
        ...
        Call<contact_general_user_update> call = apiinterface.updateProfile(headers,sharedpref.getString("name","")
                ,email.getText().toString(),sharedpref.getString("phone",""));
        call.enqueue(new Callback<contact_general_user_update>() {
            ...
            public void onResponse(Call<contact_general_user_update> call, Response<contact_general_user_update> response) {
                ...
                if (response.code() == 422) {
                    ...
                    Toast.makeText(EmailUpdate.this,jObjError.toString(),Toast.LENGTH_LONG).show();
                ...
                edt.apply();
                Dialog dialog1;
                dialog1 = new Dialog(EmailUpdate.this);
                ...
                message.setText("تم تعديل البريد الألكتروني  بنجاح");
                dialog1.show();
            }
