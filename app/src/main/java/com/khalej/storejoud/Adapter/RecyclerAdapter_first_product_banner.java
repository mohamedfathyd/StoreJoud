...
public class RecyclerAdapter_first_product_banner extends RecyclerView.Adapter<RecyclerAdapter_first_product_banner.MyViewHolder> {
    Typeface myTypeface;
    private Context context;
    List<String> contactslist;
    RecyclerView recyclerView;

    public RecyclerAdapter_first_product_banner(Context context, List<String> contactslist, RecyclerView recyclerView){
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, final int position) {
        try {
            ...
            Glide.with(context).load("https://storejoud.com/"+
                    contactslist.get(position)).error(R.drawable.logo).into(holder.image);
        }
        catch (Exception e){}
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Glide.with(context).load("https://storejoud.com/"+
                        contactslist.get(position)).error(R.drawable.logo).into(img);
                settingsDialog.show();
            }
