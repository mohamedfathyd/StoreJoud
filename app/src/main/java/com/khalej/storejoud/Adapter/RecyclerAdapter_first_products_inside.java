...
public class RecyclerAdapter_first_products_inside extends RecyclerView.Adapter<RecyclerAdapter_first_products_inside.MyViewHolder> {
    Typeface myTypeface;
    ...
    public RecyclerAdapter_first_products_inside(Context context, List<contact_products.product> contactslist){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.category_page_list,parent,false);
